# Generated by Django 5.1.2 on 2024-11-09 16:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idrights', models.ForeignKey(db_column='idrights', default=1, on_delete=django.db.models.deletion.CASCADE, to='db_editor.rights')),
            ],
            options={
                'db_table': 'tbluser',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idpostag', models.ForeignKey(blank=True, db_column='idpostag', null=True, on_delete=django.db.models.deletion.CASCADE, to='db_editor.postag')),
                ('idsentence', models.ForeignKey(db_column='idsentence', on_delete=django.db.models.deletion.CASCADE, related_name='tokens', to='db_editor.sentence')),
            ],
            options={
                'db_table': 'tbltoken',
            },
